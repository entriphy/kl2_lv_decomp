...
/* FUN_00165ae0 */ extern u8 *hReadFile(const char* name); 
...
/* FUN_00166140 */ extern void FUN_00166140(int param_1, u8 *param_2);
...
/* FUN_0016c9b8 */ extern s32 FUN_0016c9b8(u8 *dest, u8 *src, u32 size);
